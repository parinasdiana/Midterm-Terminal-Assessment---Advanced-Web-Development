...
<div class="login-card">
    ...
    <p class="subtitle">Join TaskFlow Pro to start managing tasks</p>
    
    <form action="/register" method="post">
        <div class="form-group">
            <label class="label-accent">Full Name</label>
            <input type="text" name="name" class="input-modern" placeholder="Juan Dela Cruz" required>
        </div>
        <div class="form-group">
